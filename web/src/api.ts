export interface User { id: string; email: string; name: string; role: string; enabled: boolean; created_at: string }
...
export interface Account { user_id: string; key_id: string; email: string; name: string; role: string; balance: number; reserved: number }
