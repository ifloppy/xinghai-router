  ...
  <section class="profile-layout">
    ...
    <section class="panel leaderboard-settings">
      ...
      <div class="setting-row">
        ...
        <button class="toggle" :class="{ on: leaderboardPrefs.opt_in }" type="button" :aria-label="t('leaderboardOptIn')" @click="leaderboardPrefs.opt_in = !leaderboardPrefs.opt_in; saveLeaderboardPrefs()"><i/></button>
      </div>
      <div class="setting-row">
        <div>
        ...
        <button class="toggle" :class="{ on: leaderboardPrefs.mask_name }" type="button" :aria-label="t('leaderboardMaskName')" @click="leaderboardPrefs.mask_name = !leaderboardPrefs.mask_name; saveLeaderboardPrefs()"><i/></button>
      </div>
    </section>
  </section>
</template>
