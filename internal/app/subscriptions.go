...
func readSubscriptionPlanInput(r *http.Request, s *Service, existingID string) (subscriptionPlan, error) {
	...
	if !validPlanQuotaLimit(in.MaxRequests) || !validPlanQuotaLimit(in.MaxTokens) {
...
const (
	...
	maxPlanQuotaLimit        = int64(1_000_000_000_000)
)

func validPlanQuotaLimit(value *int64) bool {
	if value == nil {
		return true
	}
	return *value >= 0 && *value <= maxPlanQuotaLimit
}
